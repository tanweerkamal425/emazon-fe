	            ...
	            <div>
	              ...
	              >
	                <div class="flex-shrink-0">
	                  ...
	                  />
	                  <div
	                    class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white blue-700 dark:border-gray-700"
	                  >
	                    <svg
	                      aria-hidden="true"
	          ...
	          >
	            ...
	            >
	              <li>
	                ...
	                > -->
					<form @submit.prevent="adminLogout">
		...
		adminLogout() {
			this.logout().then(() => {
				...
				if (error.response.status === 422) {
					...
					this.errorMessage = "Could not authenticate you. Try later.";
				}
			}).finally(() => {
