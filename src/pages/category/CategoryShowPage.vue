    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <dl class="flex items-center space-x-6">
                ...
                <div>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Deleted at</dt>
                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">2024-03-13</dd>
                </div>
            </dl>
            <dl class="flex items-center space-x-6">
            ...
            <div class="flex items-center space-x-4">
                <router-link :to="{name: 'category.edit', params: {id: 123}}" class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
