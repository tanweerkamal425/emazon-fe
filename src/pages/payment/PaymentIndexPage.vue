            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <!-- <a href="#" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 line-through">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Order Group ID</th>
                                <th scope="col" class="px-4 py-3">PG Payment ID</th>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <div class="flex flex-row">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200 flex flex-row" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <router-link :to="{name: 'payment.show', params: {id: p.id}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
...
export default {
    ...
    methods: {
        fetchPayments(query = {}) {
            this.getPayments(query).then((res) => {
                this.payments = res.data;
                console.log(res.data);
                this.$router.push({name: 'payment.index', query: query});
            }).catch((error) => {
                console.log(error);
            }).finally(() => {
                //
    ...
    computed: {
        ...mapState(usePaymentStore, ["getPayments"]),
    },
