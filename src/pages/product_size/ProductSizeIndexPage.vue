                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <div class="flex flex-row">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200 flex flex-row" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <router-link :to="{name: 'product_size.show', params: {id: ps.id}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                ...
                                                <li>
                                                    <router-link :to="{name: 'product_size.edit', params: {id: ps.id}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    methods: {
        fetchProductSizes(query = {}) {
			this.getProductSizes(query).then((data) => {
                ...
                this.$router.push({name: 'product_size.index', query: query});
			}).catch((error) => {
				console.error(error);
			}).finally(() => {
				//
        ...
        onPageChange(pageNum) {
            ...
            this.fetchProductSizes(this.query);
        }
    },
