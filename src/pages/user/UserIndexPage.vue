                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <div class="flex flex-row">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200 flex flex-row" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <router-link :to="{name: 'user.show', params: {id: u.id}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
    ...
    methods: {
        fetchUsers(query = {}) {
            this.getUsers(query).then((res) => {
                ...
                this.$router.push({name: 'user.index', query: query});
            }).catch((error) => {
                console.log(error);
            }).finally(() => {
                //
